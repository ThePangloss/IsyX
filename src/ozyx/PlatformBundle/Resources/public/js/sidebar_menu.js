  ...
  $("#menu-toggle").click(function(e) {
      ...
      $("#wrapper").toggleClass("toggled");
        if($("#menu-toggle").text() == "  Afficher le menu") {
            $(".btn-custom").html('<span class="fa fa-navicon fa-lg" aria-hidden="false"></span><b class="btnStyle">  Cacher le menu</b>');
            return false;
        }else{
            $(".btn-custom").html('<span class="fa fa-navicon fa-lg" aria-hidden="false"></span><b class="btnStyle">  Afficher le menu</b>');
            return false;
        }
  });
